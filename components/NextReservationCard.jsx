/**
 * Static "Next Reservation" card: day, party size, and confirmation badge.
 * Used at the bottom of the Notes tab.
 */
...
function NextReservationCard() {
  return (
    <div style={{ ...mainView.card, padding: "28px 36px", textAlign: "center" }}>
      ...
      <div style={{ fontFamily: fonts.display, fontSize: 18, color: colors.ink, letterSpacing: 2, marginBottom: 4 }}>Thursday</div>
